...
<body>
    <form id="form1" runat="server">
        ...
        <p>
            ...
            <p>
            <asp:GridView ID="gvTareasProf" runat="server" AutoGenerateColumns="False" DataKeyNames="Codigo" DataSourceID="sqlTareasProfTabla" OnSelectedIndexChanged="gvTareasProf_SelectedIndexChanged" AutoGenerateEditButton="True" BorderStyle="Outset" ShowHeaderWhenEmpty="True" AutoGenerateDeleteButton="True">
                <Columns>
            ...
            <p>
                <asp:SqlDataSource ID="sqlTareasProfTabla" runat="server" ConnectionString="<%$ ConnectionStrings:HADS21-19ConnectionString %>" DeleteCommand="DELETE FROM [TareasGenericas] WHERE [Codigo] = @Codigo" InsertCommand="INSERT INTO [TareasGenericas] ([Codigo], [Descripcion], [CodAsig], [HEstimadas], [Explotacion], [TipoTarea]) VALUES (@Codigo, @Descripcion, @CodAsig, @HEstimadas, @Explotacion, @TipoTarea)" SelectCommand="SELECT * FROM [TareasGenericas] WHERE ([CodAsig] = @CodAsig)" UpdateCommand="UPDATE [TareasGenericas] SET [Descripcion] = @Descripcion, [CodAsig] = @CodAsig, [HEstimadas] = @HEstimadas, [Explotacion] = @Explotacion, [TipoTarea] = @TipoTarea WHERE [Codigo] = @Codigo">
                    <SelectParameters>
                        <asp:ControlParameter ControlID="dlAsignaturas" Name="codasig" PropertyName="SelectedValue" DbType="String" DefaultValue="" />
                    </SelectParameters>
                </asp:SqlDataSource>
        </p>
        </div>
