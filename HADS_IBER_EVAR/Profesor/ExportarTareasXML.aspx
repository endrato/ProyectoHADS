<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExportarTareasXML.aspx.cs" Inherits="HADS_IBER_EVAR.Profesor.ExportarTareasXML" %>
...
<body>
    <form id="form2" runat="server">
        <table class="auto-style1">
            ...
            <tr>
                <td class="auto-style2">
                    <asp:Button ID="btnImportar" runat="server" Text="EXPORTAR" />
                    <br />
